...
import ClientFiche from "@/components/client/ClientFiche";
    ...
    <div className="space-y-6 overflow-x-hidden">
      ...
      <div className="flex flex-col md:flex-row">
        <div className="md:w-[80%] w-full pr-4">
          <ClientFiche activeTab={activeTab} downArrow={downArrow} />
        </div>
        <div className="md:w-[1/3] md:block hidden">
        <ClientCard clientDetails={clientData} activities={activityData}/>
        </div>
      </div>
    </div>
  );
