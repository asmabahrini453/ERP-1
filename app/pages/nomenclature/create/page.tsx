...
import NomenclatureCard from "@/components/nomenclature/nomenclatureCard";

const NomenclaturePage = () => {
  const [activeTab, setActiveTab] = useState("");

  const tabs = [
    { id: "article", label: "Article de production" },
    { id: "cost", label: "Configuration des coûts" },
    { id: "matiere", label: "Matiéres premières" },
