...
const NomenclatureList = () => {
  ...
  const handleEdit = (updated: Nomenclature) => {
  ...
  const handleDelete = (nomenclatureToDelete: Nomenclature) => {
    setNomenclatures(prev => 
    ...
    <div className="p-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Gérez vos nomenclatures et leurs détails
          </p>
        </div>
      ...
      <div className="bg-white rounded-lg shadow-sm p-4">
             <DataTable
                  ...
                  filterKey="codeArticle"
                  filterPlaceholder="Filtrer par code article..."
                  columnLabels={{
                    ...
                    montant: "Montant",
                    devise: "Devise",
                    avecDesOperations: "Avec opérations",
