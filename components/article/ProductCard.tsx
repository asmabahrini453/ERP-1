...
interface ProductCardProps {
    ...
    modeEvaluationStock: string
    codeModeleRangement: string
    dateDebutInventaire: string
    dateFinInventaire: string
  }
  activities: Array<{
    user: string
    action: string
...
{/* Image section */}
      ...
      <div className="p-4 border-b">
        ...
        <div className="space-y-3">
          {Object.entries(productDetails).map(([key, value], index, array) => {
            //  labels for each key
            const labels: Record<string, string> = {
              ...
              modeEvaluationStock: "Mode évaluation stock",
              codeModeleRangement: "Code modèle rangement",
              dateDebutInventaire: "Proch. date début d'inventaire",
              dateFinInventaire: "Proch. date fin d'inventaire",
            }
