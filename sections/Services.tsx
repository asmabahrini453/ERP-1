...
import Logo01 from "@/assets/images/erplogo.png";
import Logo02 from "@/assets/images/industrie.png";
import Logo03 from "@/assets/images/en-stock.png";
import Logo04 from "@/assets/images/loupe.png";
import Logo05 from "@/assets/images/pouvoir-dachat.png";
import Logo06 from "@/assets/images/emploi.png";
import Logo07 from "@/assets/images/gestionnaire-de-communaute.png";
import Logo08 from "@/assets/images/acquisition.png";
import Logo09 from "@/assets/images/money-management.png";
          ...
          <div className="pb-12 md:pb-20">
            <div className=" text-center relative z-10">
                  <div className="section-heading mb-12">
                      <h2 className="section-title font-bold">Nos services</h2>
            ...
            <div className="mt-12 flex flex-wrap gap-3 justify-center">
                    {features.map((feature) => (
                        ...
                        >
                            <span className="bg-[#3BCEAB] text-white size-5 rounded-full inline-flex items-center justify-center text-xl 
