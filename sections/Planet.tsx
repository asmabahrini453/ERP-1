...
export default function Planet() {
  return (
    <section className="relative before:absolute before:inset-0 before:-z-20 before:bg-gray-900 pt-24">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="py-12 md:py-20">
          <div className="section-heading  pb-16  md:pb-20">
            <motion.h2
             ...
             className="[background-size:200%] section-title text-gray-200 bg-[linear-gradient(to_right,#3361E0,#3BCEAB,#C4D0BA,#DDDDDD,#3BCEAB,#C4D0BA)] text-transparent bg-clip-text">
            Travail collaboratif 
            </motion.h2>
            <p className="section-description mt-5 text-muted-foreground">
            ERP Pro aide vos équipes à travailler plus efficacement ensemble
            </p>
          </div>
          {/* Planet */}
              ...
              <div className="relative inline-flex rounded-full before:absolute before:inset-0 before:-z-10 before:scale-[.85] before:animate-[pulse_4s_cubic-bezier(.4,0,.6,1)_infinite] before:bg-gradient-to-b before:from-blue-900 before:to-sky-700/50 before:blur-3xl after:absolute after:inset-0 after:rounded-[inherit] after:[background:radial-gradient(closest-side,theme(colors.blue.500),transparent)]">
                ...
                <div className="pointer-events-none" aria-hidden="true">
                  <Image
                    ...
                    width={789}
                    height={755}
                    alt="Décoration planète"
                  />
                  <div>
                    <Image
                      className="absolute -left-28 top-16 z-10 animate-[float_8s_ease-in-out_infinite_both] opacity-80 transition-opacity duration-1000"
                      src={PlanetTagImg01}
                      width={253}
                      height={56}
                      alt="Tag 01"
                    />
                    <Image
                      className="absolute left-56 top-7 z-10 animate-[float_8s_ease-in-out_infinite_1s_both] opacity-30 transition-opacity duration-1000"
                      src={PlanetTagImg02}
                      width={241}
                      height={56}
                      alt="Tag 02"
                    />
                    <Image
                      className="absolute -left-20 bottom-24 z-10 animate-[float_8s_ease-in-out_infinite_2s_both] opacity-25 transition-opacity duration-1000"
                      src={PlanetTagImg03}
                      width={243}
                      height={56}
                      alt="Tag 03"
                    />
                    <Image
                      className="absolute bottom-32 left-64 z-10 animate-[float_8s_ease-in-out_infinite_3s_both] opacity-80 transition-opacity duration-1000"
                      src={PlanetTagImg04}
                      width={251}
                      height={56}
                      alt="Tag 04"
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 [&>*]:relative [&>*]:p-6 [&>*]:before:absolute [&>*]:before:bg-gray-800 [&>*]:before:[block-size:100vh] [&>*]:before:[inline-size:1px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-1px] [&>*]:after:absolute [&>*]:after:bg-gray-800 [&>*]:after:[block-size:1px] [&>*]:after:[inline-size:100vw] [&>*]:after:[inset-block-start:-1px] [&>*]:after:[inset-inline-start:0] md:[&>*]:p-10">
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Recueillez des informations essentielles sur les performances de vos équipes
                avec des métriques détaillées comme la productivité, les tâches terminées
                et plus encore.
              </p>
            </article>
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Accédez à toutes les informations contextuelles de vos projets
                pour faciliter la collaboration entre les départements et améliorer
            ...
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Améliorez l'efficacité de vos processus grâce à des outils
                d'analyse intelligents qui identifient les goulots d'étranglement
                et proposent des solutions pour optimiser le flux de travail.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                ...
                <span>Personnalisation du code</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Adaptez la plateforme à vos besoins spécifiques avec des
                fonctionnalités de personnalisation qui permettent de créer des
                workflows sur mesure pour chaque département.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Support multilingue complet permettant à vos équipes internationales
                de collaborer efficacement dans leur langue maternelle tout en
            ...
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Tous vos processus métier dans un système unifié qui élimine
                les silos d'information et garantit que toutes les équipes
                travaillent avec les mêmes données à jour.
              </p>
            </article>
          </div>
        </div>
